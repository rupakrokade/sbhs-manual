...
//mode(-1);
function [temp,heat,stop] = pi_bda_dist(setpoint,disturbance,K,Ti,Td)
global temp heat fan u_old u_new e_old e_new S0 S1 fdfh fdt fncr fncw m err_count stop
